...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Subscribe Arie Tube',
			error: {
...
varr =
`Hallo ${pushname} I'M Arie Tube have a nice day`
lett =
`𝐁𝐨𝐭 𝐈𝐧𝐟𝐨
Creator : Arie Tube
Prefix : Multi Prefix
...
yess =`${readmore}
𝐆𝐫𝐨𝐮𝐩 𝐌𝐞𝐧𝐮
${prefix}a͎n͎t͎i͎l͎i͎n͎k͎
${prefix}w͎e͎l͎c͎o͎m͎e͎
${prefix}a͎n͎t͎i͎v͎i͎r͎t͎e͎x͎
${prefix}g͎r͎o͎u͎p͎
${prefix}l͎i͎n͎k͎g͎r͎o͎u͎p͎
${prefix}p͎r͎o͎m͎o͎t͎e͎
${prefix}d͎e͎m͎͎o͎t͎e͎
${prefix}a͎d͎d͎
${prefix}k͎i͎c͎k͎
${prefix}s͎e͎t͎p͎p͎
${prefix}s͎e͎t͎d͎e͎s͎c͎
${prefix}s͎e͎t͎n͎a͎m͎e͎
${prefix}h͎i͎d͎e͎t͎a͎g͎
${prefix}t͎a͎g͎a͎l͎l͎
${prefix}l͎k͎s͎t͎a͎d͎m͎i͎n͎
${prefix}n͎s͎f͎w͎`
but = [
...
${prefix}a͎t͎t͎p͎
${prefix}t͎o͎i͎m͎g͎
${prefix}s͎t͎i͎c͎k͎e͎r͎
${prefix}t͎o͎m͎m͎p͎3
${prefix}t͎o͎v͎i͎d͎e͎o͎`
but = [
          { buttonId: `${prefix}rulesbot`, buttonText: { displayText: '☰ RULES BOT' }, type: 1 }
        ]
        sendButLocation(from, lett, yess, foot, but)
...
𝐑𝐚𝐧𝐝𝐨𝐦 𝐌𝐞𝐧𝐮
${prefix}o͎w͎n͎e͎r͎
${prefix}s͎e͎w͎a͎b͎o͎t͎
${prefix}r͎e͎p͎o͎r͎t͎
${prefix}r͎u͎n͎t͎i͎m͎e͎
${prefix}s͎p͎e͎e͎d͎
${prefix}s͎c͎
${prefix}r͎u͎l͎e͎s͎b͎o͎t͎
${prefix}s͎h͎a͎r͎e͎l͎o͎c͎k͎`
but = [
          { buttonId: `${prefix}rulesbot`, buttonText: { displayText: '☰ RULES BOT' }, type: 1 }
        ]
        sendButLocation(from, lett, yess, foot, but)
...
yess =`${readmore}
𝐈𝐬𝐥𝐚𝐦𝐢 𝐌𝐞𝐧𝐮
${prefix}l͎i͎s͎t͎s͎u͎r͎a͎h͎
${prefix}a͎s͎m͎a͎u͎l͎h͎u͎s͎n͎a͎
${prefix}j͎a͎d͎w͎a͎l͎s͎h͎o͎l͎a͎t͎
${prefix}k͎i͎s͎a͎h͎n͎a͎b͎i͎
${prefix}a͎l͎q͎u͎r͎a͎n͎
${prefix}a͎l͎q͎u͎r͎a͎n͎a͎u͎d͎i͎o͎`
but = [
          { buttonId: `${prefix}rulesbot`, buttonText: { displayText: '☰ RULES BOT' }, type: 1 }
        ]
        sendButLocation(from, lett, yess, foot, but)
...
but = [
          { buttonId: `${prefix}sebulan`, buttonText: { displayText: '☰ 1 MINGGU' }, type: 1 },
          { buttonId: `${prefix}permanen`, buttonText: { displayText: '☰ 1 BULAN' }, type: 1 }
        ]
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe Arie Tube`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe Arie Tube' })
fs.unlinkSync(ran)
})
break
...
case 'tiktok':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://tiktok.com/@ArieTube`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'sourcecode':
case 'script':
...
`*Bot ini sewa di*
╭─────────────────────
├ Youtube = https://www.youtube.com/arietube
└─────────────────────`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
...
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: '*©Creator : Arie Tube*'})
break
case 'phkomen':
...
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: '*©Creator : Arie Tube*' })
})
break
...
break
case 'ytmp4':
if (args.length == 0) return reply(`Link Nya Mana Tod\nContoh: ${prefix + command} https://youtube.com/watch?v=ZxgfG1_gDxM`)
ini_link = args[0]
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Arie Tube'})
break
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Arie Tube'})
})
break
case 'darkjoke':
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Arie Tube'})
break
case 'asupancecan':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/cecan?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Arie Tube'})
break
case 'asupanhijaber':
